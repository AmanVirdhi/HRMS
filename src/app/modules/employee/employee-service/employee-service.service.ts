...
export class EmployeeServiceService {
  ...
  getJobById(empid: number): Observable<any> {
    //const apiUrl = `${this.configuration.getJob}/${id}`;
    // console.log(apiUrl);
    return this.httpService
      .makeGetReq(this.configuration.getJob)
      .pipe(
        map((res: any[]) => {
          //const responseBody = res.body;
          // if (res.status == "SUCCESS") {
          ...
          //   return res.errorCode;
          // }
          return res.filter((item: any) => item.empRegId == empid);
        })
      )
  }
  ...
  updateeducationDetail(formObj: any, id: any) {
    const apiUrl = `${this.configuration.addEducation}/${id}`;
    return this.httpService.makePutReq(formObj, apiUrl).pipe(map((res: any) => {
      return res
    }))
  }
  ...
  getEducationById(empid: number): Observable<any> {
    ...
    return this.httpService
      .makeGetReq(this.configuration.addEducation)
      .pipe(
        map((res: any[]) => {
          //const responseBody = res.body;
          // if (res.status == "SUCCESS") {
  ...
  getLanguageById(empid: number): Observable<any> {
    ...
    return this.httpService
      .makeGetReq(this.configuration.addLanguage)
      .pipe(
        map((res: any[]) => {
          return res.filter((item: any) => item.empRegId == empid);
        })
  ...
  getCertificateById(empid: number): Observable<any> {
    ...
    return this.httpService
      .makeGetReq(this.configuration.addCertificate)
      .pipe(
        map((res: any[]) => {
          return res.filter((item: any) => item.empRegId == empid);
        })
  ...
  //#region added by Amandeep on 29-07-2024 for country, state
  ...
  //#endregion
  //#region  Salary details in employee dashboard added by Amandeep Virdhi : 13/08/2024
  getSalaryById(id: number): Observable<any> {
    const apiUrl = `${this.configuration.getSalary}/${id}`;
    return this.httpService
      .makeGetReq(apiUrl)
      .pipe(
        map((res: any) => {
  ...
  getContactDetailById(id: any): Observable<any> {
    const apiUrl = `${this.configuration.getContact}/${id}`;
    // console.log(apiUrl);
    return this.httpService
      .makeGetReq(apiUrl)
  ...
  //#region  EPF details in employee dashboard added by Amandeep Virdhi : 16/08/2024
  getEPFById(id: number): Observable<any> {
    const apiUrl = `${this.configuration.getEPF}/${id}`;
    return this.httpService
      .makeGetReq(apiUrl)
      .pipe(
        map((res: any) => {
  ...
  //#endregion
  //#region  ESIC details in employee dashboard added by Amandeep Virdhi : 16/08/2024
  getESICById(id: number): Observable<any> {
    const apiUrl = `${this.configuration.getESIC}/${id}`;
    return this.httpService
      .makeGetReq(apiUrl)
      .pipe(
        map((res: any) => {
  ...
  //#endregion
  //#region  medical details in employee dashboard added by Amandeep Virdhi : 16/08/2024
  getMedicalById(id: number): Observable<any> {
    const apiUrl = `${this.configuration.getMedical}/${id}`;
    return this.httpService
      .makeGetReq(apiUrl)
      .pipe(
        map((res: any) => {
  ...
  saveEpfDetail(epfDetails: any): Observable<any> {
    return this.httpService
      .makePostReq(epfDetails, this.configuration.getEPF)
      .pipe(
        map((res: any) => {
          return res;
        })
  ...
  getEpfWithId(): Observable<any> {
    return this.httpService
      .makeGetReq(this.configuration.getEPF)
      .pipe(
        map((res: any) => {
          return res;
        })
  ...
  editepfdata(epfDetails: any, id: string): Observable<any> {
    const x = this.configuration.getEPF + "/" + id;
    return this.httpService.makePutReq(epfDetails, x);
  }
  // getEmployeeWithId(): Observable<any> {
  //   return this.httpService
  //     .makeGetReq(this.configuration.getEmp)
  //     .pipe(
  //       map((res: any) => {
  ...
  getMedicalWithId(): Observable<any> {
    return this.httpService
      .makeGetReq(this.configuration.getMedical)
      .pipe(
        map((res: any) => {
          return res;
        })
  ...
  saveMedical(MedicalDetails: any): Observable<any> {
    return this.httpService
      .makePostReq(MedicalDetails, this.configuration.getMedical)
  ...
  editMedicalDetails(MedicalDetails: any, id: string): Observable<any> {
    const y = this.configuration.getMedical + "/" + id;
    return this.httpService.makePutReq(MedicalDetails, y);
  }

  getEsicWithId():Observable<any> {
    return this.httpService
      .makeGetReq(this.configuration.getESIC)
      .pipe(
        map((res: any) => {
          return res;
        })
  ...
  saveEsic(EsicDetails:any):Observable<any> {
    return this.httpService
        .makePostReq(EsicDetails,this.configuration.getESIC)
