...
const routes: Routes = [
    ...
    { path: 'epf', component: EpfComponent,data: { title: 'Employee/EPF' } },
    { path: 'medical', component: MedicalComponent,data: { title: 'Employee/Medical' } },
    { path: 'esic', component: EsicComponent,data: { title: 'Employee/ESIC' } },
];
