...
export class EmployeeInfoComponent {
  ...
  // dataSource = new MatTableDataSource(this.workExpArr);
  ...
  ngOnInit() {
    ...
    this.getAllSkill();
    // this.dataSource = new MatTableDataSource(this.workExpArr);
...
//#REGION added by Amandeep on 29-07-2024 for format date 
